...
*/		
		foreach($arrItem as $arr)
		{
                        ...
                        $perso->changePvMax('-', $arr['db_shock_pv']);
                        $perso->changePaMax('-', $arr['db_shock_pa']);
			...
			/* Suppression de ce bout de code qui devrait ne servir à rien dans la mesure où toutes les drogues arrivées ici
                         * ne devraient être que des paquets de 1. Pour réactiver, réactivez avec le bloc ligne 382.
