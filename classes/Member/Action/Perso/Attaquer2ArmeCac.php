...
*/
class Member_Action_Perso_Attaquer2ArmeCac extends Member_Action_Perso_Attaquer2
{

	/** Lancer une attaque
	*
	* Exemple d'utilisation - Attaquer une victime avec une arme de cac
	* <code>
	...
	*/
										...
										$estUneRiposte=false)
	{
		...
		$tauxReussiteATT = $perso->getChancesReussite("ARMC");
