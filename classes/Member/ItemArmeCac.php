<?php
/** Gestion des armes de CaC.
 *
 * @package Member
 * @subpackage Item
 */
class Member_ItemArmeCac extends Member_ItemArme
{
	 ...
	 * @return string
	 */	
	public function getType()			{ return 'Arme Cac'; }
	
	/** Retourne le type (nom technique) de l'item (pour l'affichage)
	 * @return string
	 */	
	public function getTypeTech()		{ return 'arme_cac'; }
