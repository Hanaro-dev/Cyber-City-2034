...
class Member_index
{
	public static function generatePage(&$tpl, &$session, &$account, &$perso)
	{
		...
		{
			//throw $e;
			return fctErrorMSG('Le site est en maintenace, vous ne pouvez acceder a votre personnage. Nous vous invitons a vous rendre sur le forum (http://forum.cybercity2034.com/viewtopic.php?f=2&t=717).', '?m=News', null, false);
		}
