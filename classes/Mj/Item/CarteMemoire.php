<?php
/** Gestion de l'interface pour les cartes mémoires
*
* @package Mj
*/
class Mj_Item_CarteMemoire
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/CarteMemoire.htm');
	}
}
