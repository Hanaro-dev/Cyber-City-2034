<?php
/** Gestion de l'interface pour les items de type defense
*
* @package Mj
*/
class Mj_Item_Defense
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		$arrTriable = array(
						...
						'db_valeur','db_pr', 'db_seuilresistance',
						'db_resistance'
					);
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Defense.htm');
	}
}
