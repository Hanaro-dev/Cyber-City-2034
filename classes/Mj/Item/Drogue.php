<?php
/** Gestion de l'interface pour les items de type drogue
*
* @package Mj
*/
class Mj_Item_Drogue
{
	public static function generatePage(&$tpl, &$session, &$account, &$mj)
	{
		...
		return $tpl->fetch($account->getSkinRemotePhysicalPath() . '/html/Mj/Item/Drogue.htm');
	}
}
