...
class Mj_Lieu_ProducteurAdd
{
	...
	private static function save()
	{
		...
		$query = 'INSERT INTO ' . DB_PREFIX . 'producteur'
				. ' (lieuId, cash, pa_cash_ratio, total_pa, pa_needed, comp_requise, comp_lvl, comp_xp, lieuMenuId)'
				. ' VALUES'
				. ' (:lieuId, :cash, :ratio, :totalPa, :pa, :comp_requise, :comp_lvl, :comp_xp, :lieuMenuId);';
		$prep = $db->prepare($query);
		$prep->bindValue(':lieuId',	$_POST['lieuId'],			PDO::PARAM_INT);
