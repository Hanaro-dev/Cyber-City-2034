...
class Mj_Perso_He
{
	...
	private static function listMessages($from, $nbr, $persoId)
	{
		...
		. 'WHERE he.msg IS NOT NULL ORDER BY he.`date` DESC, hid ASC, ft.fromto ASC , p.nom ASC;';
		...
		foreach($arrAll as &$arr)
		{
			...
			else
			{
				...
				{
                                    /**
                                     @todo C'est là que les he semble merdouiller, dans l'appel à addFromTo
                                     */
