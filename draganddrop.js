...
var dragobj; //DG qui est en train d'étre dragué
...
function FindDiv(type,name){ //Fonction qui retourne l'objet selon son type et son nom (id, param#2)
	//Trouver le DG
	var dgIds;
	var dgId;
...
//Surveiller les événements qui lance le drag
if (document.attachEvent) { //IE
...
//Afin d'éviter que le drag sélectionne du texte en arriére plan lors de déplacements
