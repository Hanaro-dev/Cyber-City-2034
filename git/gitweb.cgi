...
my $projectroot = '/home/balamweb/domains/cc4.balam-web.fr/public_html/git';
...
my $snapshots_url = 'http://cc4.balam-web.fr/git';
my $git_base_url = 'http://cc4.balam-web.fr/git';
